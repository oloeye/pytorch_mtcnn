...
from core.detecter import rnet_detect_faces
from core.utils import *

# 已经训练好的模型
p_model_path = '../data/models/pnet_epoch_2.pt'
r_model_path = '../data/models/rnet_epoch_1.pt'

def create_onet_data(save_size = 48):
    ...
    create_dirs([neg_dir, pos_dir, part_dir])
    ...
    if not os.path.exists(save_file):
        ...
        for test_data in tqdm(data['images']):
            ...
            bounding_boxes, landmarks = rnet_detect_faces(rnet_rgb_img, bounding_boxes, r_model_path)
